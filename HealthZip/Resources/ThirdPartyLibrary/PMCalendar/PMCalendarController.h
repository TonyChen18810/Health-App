...
/** added By Pankaj
 * if only month value is changed by user then this property become true else false
 */
@property (nonatomic) BOOL isOnlyMonthChnaged;
...
@property (nonatomic) PMCalendarView *objPmCalenderView;
