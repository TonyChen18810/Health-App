...
- (CGFloat)textWidthForFont:(UIFont *)font withMaxHeight:(CGFloat)maxHeight
{
	...
	CGSize maximumLabelSize = CGSizeMake(maxWidth,maxHeight);
	CGSize expectedLabelSize = [self sizeWithFont:font constrainedToSize:maximumLabelSize lineBreakMode:NSLineBreakByWordWrapping];
//	CGSize es = [self boundingRectWithSize:maximumLabelSize options:NSStringDrawingUsesLineFragmentOrigin attributes:[NSDictionary dictionaryWithObjectsAndKeys:NSFontAttributeName,font, NSLineBreakByCharWrapping, nil ] context:nil]
