...
@interface MFSideMenuContainerViewController ()
{
    ...
    UIPanGestureRecognizer *recognizer2;
}
...
- (void)setDefaultSettings {
    ...
    if (screenWidth == 320)
        self.menuWidth = 130.0f;
    else
        self.menuWidth = 150.0f;
...
- (UIPanGestureRecognizer *)panGestureRecognizer {
    ...
    recognizer1= [[UIPanGestureRecognizer alloc]
...
- (UIPanGestureRecognizer *) panGestureRecognizerMenu
{
  
    if(!recognizer2)
    {
    recognizer2= [[UIPanGestureRecognizer alloc]
                  initWithTarget:self action:@selector(handlePan:)];
    [recognizer2 setMaximumNumberOfTouches:1];
    [recognizer2 setDelegate:self];
    }
    return recognizer2;
}
...
- (void)addGestureRecognizers {
    ...
    [menuContainerView addGestureRecognizer:[self panGestureRecognizerMenu]];
}
...
//    appDelegate.viewStatusBarColor.backgroundColor = [UIColor colorWithRed:54.0/255.0 green:59.0/255.0 blue:72.0/255.0 alpha:1.0];
//    NSLog(@"Here %lf",xOffset);
//    CGRect newFrame = appDelegate.viewStatusBarColor.frame;
//    newFrame.size.width = xOffset;
//    appDelegate.viewStatusBarColor.frame = newFrame;
//    appDelegate.viewStatusBarColor.hidden = NO;
//    
